...
export function getTemplate(communicationCode: string, myTeam: string, templateId: string) {
	...
	var thisConfiguration = configurations.configuration.find(
		(template) => template.templateId == templateId
	)!;
	var JsonDatas = {
		team: myTeam,
		code: communicationCode,
		businessProviderCode: thisConfiguration.businessProviderCode,
		partnerCode: thisConfiguration.partnerCode,
		productCode: thisConfiguration.productCode,
		businessUnitCode: thisConfiguration.businessUnitCode,
		channelType: thisConfiguration.channelType,
